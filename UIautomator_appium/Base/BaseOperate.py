...
class OperateElement:
    ...
    def operate_by(self, operate, testInfo, logTest, device):
        try:
            ...
            elements = {
                ...
                ## addd send_key
                be.TESTSEND_KEY: lambda :self.testsend_key(operate)
            }
    ...
    ##### 输入事件
    def testsend_key(self, mOperate):
        self.elements_by(mOperate).send_keys(mOperate.get("code"))
        return {'result': True}
